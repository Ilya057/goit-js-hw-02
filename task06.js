...
// // Операция ввода числа пользователем
// и сохранение в массив продолжается до тех пор,
// пока пользователь не нажмет Cancel в prompt.
// // После того как пользователь прекратил
// ввод нажав Cancel, если массив не пустой, необходимо посчитать сумму всех элементов массива
...
// // 🔔 Делать проверку того, что пользователь
//  ввел именно число, а не произвольный набор символов,
